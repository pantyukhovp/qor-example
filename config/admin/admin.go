...
import (
	...
	"github.com/pantyukhovp/qor-example/config/i18n"
...
func init() {
	...
	page.Meta(&admin.Meta{Name: "QorWidgetSettings", Config: &admin.SelectManyConfig{RemoteDataResource: Widgets.WidgetSettingResource}})
